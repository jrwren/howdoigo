...
README.fo: README.xml
	"xsltproc"  --stringparam callout.graphics 0 --stringparam navig.graphics 0 --stringparam admon.textlabel 1 --stringparam admon.graphics 0 --stringparam toc.section.depth 1 --stringparam chunk.section.depth 0  --output "README.fo" "/etc/asciidoc/docbook-xsl/fo.xsl" "README.xml"  --stringparam  page.height 7in --stringparam  page.width 5in
